...
public class TambahPemasukanActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                datePickerDialog = newInstance(TambahPemasukanActivity.this, Year, Month, Day);
                ...
                datePickerDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                    ...
                    public void onCancel(DialogInterface dialog) {
                        Toast.makeText(TambahPemasukanActivity.this, "Datepicker Canceled", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SqliteHelper databaseHelper = new SqliteHelper(TambahPemasukanActivity.this);
        ...
        kembali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TambahPemasukanActivity.this, BerandaActivity.class);
